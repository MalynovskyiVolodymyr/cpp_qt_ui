...
ApplicationWindow {
    ...
    property variant primaryPalette: ["#C5CAE9", "#3F51B5", "#303F9F", "#000000", "#FFFFFF", "#FFFFFF", "black", "white", "white"]
    ...
    property variant accentPalette: ["#FFCCBC", "#FF5722", "#E64A19", "#000000", "#FFFFFF", "#FFFFFF", "black", "white", "white"]
    ...
    property variant themePalette: ["#000000", "#FFFFFF", "0.87", "0.54", "0.12", "0.54", "0.26", "black", "0", "#424242", "#424242", "1.0", "0.7", "#323232", "0.75"]
    ...
    StackView {
        ...
        Loader {
            ...
            source: "/wmui/pages/InitialItemPage.qml"
            active: true
            visible: false
            onLoaded: {
